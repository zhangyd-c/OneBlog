...
CREATE TABLE `biz_article`  (
  ...
  `content_md` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'markdown版的文章内容',
...
CREATE TABLE `sys_user`  (
  ...
  `source` enum('GITHUB','WEIBO','QQ','ZHYD') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'ZHYD' COMMENT '用户来源(默认ZHYD=本网站注册用户)',
