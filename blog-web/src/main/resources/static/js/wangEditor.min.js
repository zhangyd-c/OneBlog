        ...
        function(t, e) {
            ...
            u.prototype = {
                ...
                _insert: function(t, e) {
                    ...
                    for (n = 0; n < t; n++) {
                        if (o += "<tr>", 0 === n) for (i = 0; i < e; i++) o += "<th>&nbsp;</th>";
                        else for (i = 0; i < e; i++) o += "<td>&nbsp;</td>";
                        o += "</tr>"
                    }
                    o += "</table><p><br></p>";
                    var r = this.editor;
                                ...
                                if (B.open("POST", o), B.timeout = g, B.ontimeout = function() {
                                            ...
                                            if (4 === B.readyState) {
                                                ...
                                                if (f.customInsert || "0" == t.errno) {
                                                    if (f.customInsert && "function" == typeof f.customInsert) f.customInsert(e.insertLinkImg.bind(e), t, n);
                                                    else {
            ...
            H.prototype = {
                ...
                _initDom: function() {
                    var t = this,
                            ...
                            l = void 0,
                            d = void 0;
                    null == i ? (A = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(A).append(s), A.css("border", "1px solid #009a61").css("border-radius", "15px 4px 0 0").css("border-bottom", "0"), s.css("border", "1px solid #009a61").css("border-radius", "0px 0px 15px 0px").css("height", "100%").css("max-height", "115px")) : (A = n, s = o(i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), d && d.length ? l.append(d) : l.append(o("<p><br></p>")), s.append(l), A.addClass("w-e-toolbar"), s.addClass("w-e-text-container"), s.css("z-index", a), l.addClass("w-e-text");
